...
- **Tool-calling loop cap is 10 iterations**: `callGeminiWithTools()` stops after 10 rounds to prevent runaway loops. Do not increase without measuring latency impact.
